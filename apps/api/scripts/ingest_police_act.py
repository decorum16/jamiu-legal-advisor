...
from app.services.ingestion.police_act_preprocessor import preprocess_police_act_text
...
def main():
    ...
    try:
        input_path = PROJECT_ROOT / "Legal_sources" / "police-act2020.txt"
        raw_text = input_path.read_text(encoding="utf-8")

        cleaned_text = preprocess_police_act_text(raw_text)
        chunks = parse_statute_text(cleaned_text, source_title=SOURCE_TITLE)
